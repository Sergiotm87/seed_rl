...
#flags.DEFINE_string('server_address', 'localhost:8686', 'Server address.', allow_hide_cpp=True)
flags.DEFINE_string('server_address', 'learner:8686', 'Server address.', allow_hide_cpp=True)
